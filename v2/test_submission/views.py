...
def newsubmission(request):
	...
	if(request.method == "GET"):
		...
		student_id = float(request.POST.get('student_id'))
		xblock_id = request.POST.get('xblock_id')
		attempted = float(request.POST.get('attempted'))
		correctly_attempted = float(request.POST.get('correctly_attempted'))
		time_taken = float(request.POST.get('time_taken'))
		timestamp = request.POST.get('timestamp')
		appeared_in_test = float(request.POST.get('appeared_in_test'))
		appeared_in_gym = float(request.POST.get('appeared_in_gym'))
